...
export default function ContactForm() {
  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 dark:text-white p-6 shadow-lg rounded-lg">      <SEOComponent />
      ...
      {activeTab === "appointment" && (
        <form onSubmit={(e) => handleSubmit(e, "appointment")} className="grid gap-3">
          ...
          <input type="email" name="email" value={appointmentData.email} onChange={(e) => handleChange(e, "appointment")} placeholder="Email" className="input-field" required />
          <input type="text" name="phone_number" value={appointmentData.phone_number} onChange={(e) => handleChange(e, "appointment")} placeholder="Phone Number" className="input-field" required />
          ...
          <textarea name="message" value={appointmentData.message} onChange={(e) => handleChange(e, "appointment")} placeholder="Leave us a message..." className="input-field" rows="3"></textarea>
      ...
      {activeTab === "inquiry" && (
        <form onSubmit={(e) => handleSubmit(e, "inquiry")} className="grid gap-3">
          ...
          <input type="email" name="email" value={inquiryData.email} onChange={(e) => handleChange(e, "inquiry")} placeholder="Email" className="input-field" required />
          <input type="text" name="phone" value={inquiryData.phone_number} onChange={(e) => handleChange(e, "inquiry")} placeholder="Phone Number" className="input-field" required />
          ...
          <textarea name="message" value={inquiryData.message} onChange={(e) => handleChange(e, "inquiry")} placeholder="Leave us a message..." className="input-field" rows="3"></textarea>
