...
const seoConfig = {
    ...
    "/manifest.json": {
      title: "Avida Land PWA Manifest",
      description: "Progressive Web App settings for Avida Land.",
      image: "/default-property.jpg",
    },
    "/properties": {
    ...
    // 🔐 Admin Pages
    "/admin/about-us": {
      title: "Admin - About Us Settings",
      description: "Manage company mission, vision, and about content from the admin panel.",
      image: "/default-property.jpg",
    },
    "/admin/appointment": {
      title: "Admin - Manage Appointments",
      description: "View and update scheduled appointments for property viewings and meetings.",
      image: "/default-property.jpg",
    },
    "/admin/contacts": {
      title: "Admin - Contact Inquiries",
      description: "Review and manage user contact messages submitted via the website.",
      image: "/default-property.jpg",
    },
    "/admin/dashboard": {
      title: "Admin Dashboard - Avida CMS",
      description: "Overview of system analytics, activity logs, and quick insights.",
      image: "/default-property.jpg",
    },
    "/admin/inquiries": {
      title: "Admin - Service Inquiries",
      description: "Manage all service and inquiry messages received from users.",
      image: "/default-property.jpg",
    },
    "/admin/job-applications": {
      title: "Admin - Job Applications",
      description: "View and respond to job applications submitted by users.",
      image: "/default-property.jpg",
    },
    "/admin/jobs": {
      title: "Admin - Job Listings",
      description: "Create, edit, and publish job opportunities to the careers portal.",
      image: "/default-property.jpg",
    },
    "/admin/news": {
      title: "Admin - Manage News",
      description: "Publish real estate blogs and news updates from the admin panel.",
      image: "/default-property.jpg",
    },
    "/admin/profile": {
      title: "Admin - My Profile",
      description: "Update your administrator profile information and settings.",
      image: "/default-property.jpg",
    },
    "/admin/properties": {
      title: "Admin - Property Listings",
      description: "Manage all real estate listings including status, media, and pricing.",
      image: "/properties-banner.jpg",
    },
    "/admin/services": {
      title: "Admin - Services",
      description: "Manage available services offered by the real estate company.",
      image: "/default-property.jpg",
    },
